...
const descriptions: Record<string, [string, string]> = {
  ...
  'Moonflower Diadem':['Amlaruil Moonflower elveszett diadémja, mely ragyogó fénnyel áldja meg viselőjét.','The lost diadem of Amlaruil Moonflower, blessing its wearer with radiant light.'],
  ...
  'A Lélekösvény fejdísze':['Ősi fejdísz, amely viselőjét a lények emlékeihez és szelleméhez kapcsolja.','An ancient headdress that connects its wearer to the memories and spirits of creatures.'],
};
