...
const descriptions: Record<string, [string, string]> = {
  ...
  'Cast-Iron Critical Clanger':['Öntöttvas fegyver, amelynek pusztító csapásait fülsüketítő kongás kíséri.','A cast-iron weapon whose devastating blows ring with a deafening clang.'],
