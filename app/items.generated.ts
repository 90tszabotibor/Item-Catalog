export const items = [
  ...
  },
  {
    ...
    "price": 3490,
    "summary": "Aktiválás: Bónuszakció",
    "details": "**+1 tőr**\n\n**Blinkstep:**\n\nAktiválás: Bónuszakció\nHasználat: Hosszú pihenőnként 3x\n\nEldobod a tőrt egy általad látható lény vagy üres pont felé. A dobás pillanatában a tőrrel együtt rövid időre az Éteri Síkra kerülsz.\n\nHa a tőr eltalálja a célpontot, vagy eléri a kijelölt pontot, azonnal a tőr mellé teleportálsz. Ha a Blinksteppel támadást hajtottál végre, a támadás további 1d6 force sebzést okoz.\n\nA tőr ezután mágikusan visszatér a kezedbe. Ha a kezed tele van, a lábadhoz esik.\n\n**Darkness:**\n\nA varázslat időtartama alatt mágikus sötétség terjed ki egy hatótávon belüli pontból, és kitölt egy 15 láb sugarú gömböt. A Darkvision nem lát át rajta, és nem mágikus fény nem világíthatja meg.\n\nA varázslatot egy nem viselt vagy hordozott tárgyra is elsütheted. Ekkor a sötétség a tárgyból kiinduló, 15 láb sugarú területet tölt ki. Ha a tárgyat valami átlátszatlannal, például egy tállal vagy sisakkal letakarják, a sötétség nem terjed tovább.\n\nHa a varázslat területe átfedésbe kerül egy 2. vagy alacsonyabb szintű varázslat által létrehozott Bright Light vagy Dim Light területével, a másik varázslat megszűnik."
  },
  {
    "id": 21,
