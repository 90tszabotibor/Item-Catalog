...
const enDetailOverrides: Record<string, string> = {
  ...
  'Displacer’s Deceptive Duster': 'Deceptive Displacer Duster\n\n**14 AC + Dex mod**\n\n**Displacement:**\n\nActivation: Action\nUse: 1x per long rest\nDuration: 10 rounds\n\nThe cloak distorts the wearer’s apparent position. For the duration, all attacks against the wearer are made with disadvantage.',
  ...
  'Prismatic Psychedelic Peepers': 'Prismatic Psychedelic Peepers\n\n**+2 illusion**\n\n**Hypnotic Pattern:**\n\nUse: 1x per long rest\n\nYou can cast Hypnotic Pattern from the glasses.',
